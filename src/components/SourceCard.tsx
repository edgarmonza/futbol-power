...
export default function SourceCard({ source, index }: SourceCardProps) {
  return (
    <motion.div
      ...
      className="snap-x-item h-[calc(100dvh-80px)] w-full flex-shrink-0 p-3 lg:p-4"
    >
      <div className="flex h-full flex-col rounded-[28px] overflow-hidden bg-obsidian-card border border-white/5 hover:border-accent/20 transition-all duration-300">
        {/* ── Header ── */}
            ...
            {source.recentArticles.map((article, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[13px] font-semibold text-bone leading-snug line-clamp-2 group-hover/item:text-accent transition-colors">
                    {article.title}
                  </p>
        ...
        {/* ── Footer Stats ── */}
        <div className="shrink-0 px-6 py-4 border-t border-white/5 bg-accent/[0.02]">
