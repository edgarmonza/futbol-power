      ...
      <div className="h-full rounded-[28px] overflow-hidden bg-obsidian-card border border-white/5 hover:border-accent/20 transition-all duration-300">
        <div className="h-full overflow-y-auto no-scrollbar">
          <a
            ...
            className="flex flex-col min-h-full group cursor-pointer"
          >
            {/* ── Image Section (16:9) ── */}
            ...
            <div className="flex flex-1 flex-col justify-between p-5 lg:p-6">
              <div>
                ...
                <h2 className="text-xl lg:text-2xl xl:text-3xl font-bold text-bone tracking-tight leading-[1.15] group-hover:text-accent transition-colors duration-300">
                  {article.title}
                </h2>
                {article.excerpt && (
